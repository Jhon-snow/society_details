...
import './newentryind.css' 
import {BrowserRouter as Router, Route, Link} from 'react-router-dom'
import { Signin } from '../Signin/signin';
import { Header } from '../Header/header';
import Dashboard from '../Dashboard/dashboard';
 const Newentryind: React.FC = () =>{
    ...
    const societyregister = () =>{
        ...
        "location":location,
        "societytype":"Independent Building",
        "fencing":fencing,
        "guard":guard,
        "no_of_wings":0,
...
return(
    ...
    <div className="card-body">
        ...
        <label className="label1">Society Type</label>
            <label className="label1">Independent Building</label>
    ...
    <Link to="/dashboard"><button className="register-btn" onClick={societyregister}>Register</button></Link>
